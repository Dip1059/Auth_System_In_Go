...
import (
	...
	H "Auth_System_In_Go/Helpers"
	M "Auth_System_In_Go/Middlewares"
	Mod "Auth_System_In_Go/Models"
	R "Auth_System_In_Go/Repositories"
	S "Auth_System_In_Go/Services"
	"encoding/base64"
...
func Welcome(c *gin.Context) {
	...
	if _, success := M.IsGuest(c, store); success {
...
func RegisterPost(c *gin.Context) {
	...
	user.EmailVf.String = H.RandomString(60)
	user.EmailVf.Valid = true
	user.Role = 2
...
func Home(c *gin.Context) {
	...
	if user, success := M.IsAuthUser(c, store); success {
...
func Dashboard(c *gin.Context) {
	...
	if user, success := M.IsAuthAdminUser(c, store); success {
